...
class App(ctk.CTk):
    ...
    def __init__(self):
        ...
        self._header_frame.grid(padx=(self._pad, 0), pady=(self._pad, 0))
        self._options_frame.grid(padx=(self._pad, 0), pady=(0, self._pad))
    ...
    def _create_options_frame(self):
        """
        Creating the frame to set all definitions
        """
